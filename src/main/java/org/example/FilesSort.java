...
public class FilesSort {
    ...
    public static LinkedList<Double> readCSV(String filename) throws IOException {
    ...
    public static void convertingDataToBestCase(String name_File_of_data_average_case, String directoryBestcase ,String name_File_of_data_best_case) throws IOException {
        LinkedList<Double> linkedList = readCSV(name_File_of_data_average_case);
    ...
    public static long calculeTimeOfSort(String name_of_csv){
        long time = -1;
        try {
            LinkedList<Double> dataList = readCSV(name_of_csv);
